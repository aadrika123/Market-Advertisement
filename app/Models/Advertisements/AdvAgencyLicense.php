...
class AdvAgencyLicense extends Model
{
    ...
    //         'typology' => json_encode($req->typology),
    //     ];
    //     return $metaReqs;
    // }
    ...
    //     $licenceId=AdvAgencyLicense::create($LicencesMetaReqs)->id;
    ...
    // {
    //     $inbox = DB::table('adv_agency_licenses')
    //         ->select(
    //             'id',
    //             'application_no',
    //             'application_date',
    ...
    // {
    //     $outbox = DB::table('adv_agency_licenses')
    //         ->select(
    //             'id',
    //             'application_no',
    //             'application_date',
