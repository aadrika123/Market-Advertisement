...
class MarHostel extends Model
{
    ...
    public function getApplicationWithStatus($request)
    {
        ...
        $approved = MarHostel::select(
            ...
            'mar_hostels.rule',
            'mar_hostels.organization_type',
            'mar_hostels.hostel_type',
            'mar_hostels.ulb_id',
            'mar_hostels.license_year',
            DB::raw("'Approve' as application_status")
        )
            ->join('ulb_ward_masters', 'ulb_ward_masters.id', 'mar_hostels.entity_ward_id')
            ->where('mar_hostels.ulb_id', $ulbId)
            ->whereBetween('application_date', [$dateFrom, $dateUpto]);

        $rejected = MarRejectedHostel::select(
            ...
            'mar_rejected_hostels.application_type',
            'mar_rejected_hostels.entity_ward_id',
            'mar_rejected_hostels.rule',
            'mar_rejected_hostels.organization_type',
            'mar_rejected_hostels.hostel_type',
            'mar_rejected_hostels.ulb_id',
            'mar_rejected_hostels.license_year',
            DB::raw("'Reject' as application_status")
        )
            ->join('ulb_ward_masters', 'ulb_ward_masters.id', 'mar_rejected_hostels.entity_ward_id')
