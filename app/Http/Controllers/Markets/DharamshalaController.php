...
use App\Models\Markets\MarActiveDharamshalaLog;
...
class DharamshalaController extends Controller
{
            ...
            if ($key && $parameter) {
                ...
                switch ($key) {
                    ...
                    case 'applicantName':
                        ...
                        break;
                    case 'applicationNo':
                        $applications = $applications->where('mar_dharamshalas.application_no', 'LIKE', "%$parameter%");
                        break;
                    default:
    ...
    public function listBtcInboxJsk(Request $req)
    {
        try {
            ...
            $mMarActiveLodge = new MarActiveDharamshala();
            ...
            if ($key && $parameter) {
                ...
                switch ($key) {
                    case 'mobileNo':
                        $applications = $btcList->where('mar_active_dharamshalas.mobile_no', 'LIKE', "%$parameter%");
                        break;
                    case 'applicantName':
                        $applications = $btcList->where('mar_active_dharamshalas.applicant', 'LIKE', "%$parameter%");
                        break;
                    case 'applicationNo':
                        $applications = $btcList->where('mar_active_dharamshalas.application_no', 'LIKE', "%$parameter%");
                        break;
                    default:
                        throw new Exception("Invalid Data");
                }
    ...
    public function getRejectedDetailsById(Request $req)
    {
        ...
        try {
            $applicationId = $req->applicationId;
            $mAdvActiveSelfadvertisement = new MarActiveDharamshala();
            $mtransaction = new AdvMarTransaction();
    ...
    public function getUploadDocumentsBtc(Request $req)
    {
        ...
        try {
            $mWfActiveDocument      = new WfActiveDocument();
            $mAdvAgency             = new MarActiveDharamshala();
            $refDocUpload           = new DocumentUpload;
            $applicationId          = $req->applicationId;
    ...
    public function searchApplicationViewById(Request $req)
    {
        ...
        try {
            ...
            $refDocUpload           = new DocumentUpload;
            $mAdvActiveSelfadvertisement = new MarDharamshala();
            $activelodge = new MarActiveDharamshala();
            $rejectedlodge = new MarRejectedDharamshala();
            $mtransaction = new AdvMarTransaction();
    ...
    public function geteEditedApplicationDetails(Request $req)
    {
        ...
        try {
            // Variable initialization
            $mMarActiveLodge = new MarActiveDharamshalaLog();
