...
import LodgeHostelForm from './LodgeHostelForm';
import LodgeHostelDocForm from './LodgeHostelDocForm';
import ReviewLodgeHostel from './ReviewLodgeHostel';


function LodgeHostelIndex() {
    ...
    return (
        <>
            ...
            <div className='overflow-x-clip '>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 bg-white p-2 rounded-md shadow-md shadow-violet-200  '>
                    <div className=''>
                        <div className='flex flex-row '>
                            <h1 className='text-2xl ml-4 text-gray-600 font-sans font-semibold'>LODGE/HOSTEL HALL REGISTRATION APPLICATION</h1>
                        </div>
                ...
                <div className={`${formIndex == 1 ? 'translate-x-0' : 'translate-x-full'} transition-all`}><LodgeHostelForm values={values} /></div>
                <div className={`${formIndex == 2 ? 'translate-x-0' : 'translate-x-full'} transition-all`}><LodgeHostelDocForm values={values} /></div>
                <div className={`${formIndex == 3 ? 'translate-x-0' : 'translate-x-full'} transition-all`}><ReviewLodgeHostel values={values} reviewIdNameData={reviewData} allFormData={allFormData} submitFun={submitButtonToggle} /></div>
            </div>
        </>
    )
}

export default LodgeHostelIndex