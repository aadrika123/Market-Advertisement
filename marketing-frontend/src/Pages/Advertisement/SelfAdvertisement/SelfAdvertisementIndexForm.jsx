...
import SelfAdvertisementForm from './SelfAdvertisementForm'
...
function SelfAdvertisementIndexForm() {
    ...
    return (
        <>
            <div className={`${animateform1} transition-all relative`}><SelfAdvertisementForm  backFun={backFun} nextFun={nextFun} toastFun={notify} /></div>

            <div className={`${animateform2} transition-all relative`}><SelfAdvertisementDocForm  backFun={backFun} nextFun={nextFun} toastFun={notify}/></div>
