...
function MovablePaymentModal(props) {
    // Modal.setAppElement('#yourAppElement');
    const [modalIsOpen, setIsOpen] = React.useState(false);

    const { api_getMovableVehicleOrderIdForPayment } = AdvertisementApiList()
    ...
    const payNow = (e) => {
        ...
        axios.post(`${api_getMovableVehicleOrderIdForPayment}`, requestBody, ApiHeader())
...
export default MovablePaymentModal; 
