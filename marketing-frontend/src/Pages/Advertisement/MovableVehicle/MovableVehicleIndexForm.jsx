...
function MovableVehicleIndexForm() {
  ...
  return (
    <div>
      <div className={`${animateform1} transition-all relative`}><MovableVehicleForm backFun={backFun} nextFun={nextFun} toastFun={notify} /></div>

      <div className={`${animateform2} transition-all relative`}><MovableVehicleDocForm backFun={backFun} nextFun={nextFun} toastFun={notify} /></div>
