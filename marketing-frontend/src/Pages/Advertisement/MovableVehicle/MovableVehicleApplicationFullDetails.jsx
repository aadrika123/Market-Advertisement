...
function MovableVehicleApplicationFullDetails(props) {

    const { api_getMovableAppliedApplicationDetail, api_getMovableAppliedDocumentList } = AdvertisementApiList()
    ...
    const getApplicationDetail = () => {
        ...
        axios.post(`${api_getMovableAppliedApplicationDetail}`, requestBody, ApiHeader())
    ...
    const getAppliedDocumentList = () => {
        ...
        axios.post(`${api_getMovableAppliedDocumentList}`, requestBody, ApiHeader())
            .then(function (response) {
...
export default MovableVehicleApplicationFullDetails