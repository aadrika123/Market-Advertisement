...
function HoardingRejectedApplication(props) {
    ...
    const { api_getHoardingRejectedApplicationList, api_getAgencyAppliedDocumentList } = AdvertisementApiList()
    ...
    const getApplicationDetail = () => {
        ...
        axios.post(`${api_getHoardingRejectedApplicationList}`, requestBody, ApiHeader())
...
export default HoardingRejectedApplication