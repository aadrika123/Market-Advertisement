...
function HoardingForm2(props) {
    ...
    const { api_getAgencyTypologyList } = AdvertisementApiList()
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            props.collectFormDataFun('hoarding2', values)
            props?.nextFun(2)
        },
    });
    ...
    const getTypologyList = () => {
        ...
        axios.post(`${api_getAgencyTypologyList}`, requestBody, ApiHeader())
