...
function HoardingFormDoc(props) {
  ...
  const handleDocument = () => {
    props.collectFormDataFun('hoardingDoc', [collectDoc])
    props?.nextFun(5)
  }
