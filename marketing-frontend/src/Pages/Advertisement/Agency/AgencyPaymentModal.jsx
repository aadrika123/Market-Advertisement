...
function AgencyPaymentModal(props) {
    // Modal.setAppElement('#yourAppElement');
    const [modalIsOpen, setIsOpen] = React.useState(false);

    const { api_getAgencyOrderIdForPayment } = AdvertisementApiList()
    ...
    const payNow = (e) => {
        ...
        axios.post(`${api_getAgencyOrderIdForPayment}`, requestBody, ApiHeader())
