...
import AgencyDocForm from './AgencyDocForm'
import AgencyForm from './AgencyForm'

function AgencyIndexForm() {
  ...
  return (
    <>
      <div>
        <div className={`${animateform1} transition-all relative`}><AgencyForm backFun={backFun} nextFun={nextFun} toastFun={notify} /></div>

        <div className={`${animateform2} transition-all relative`}><AgencyDocForm backFun={backFun} nextFun={nextFun} toastFun={notify} /></div>
      </div>
    </>
  )
}

export default AgencyIndexForm