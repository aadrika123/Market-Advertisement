...
function PrivateLandApplicationFullDetail(props) {

    const { api_getPrivateLandAppliedApplicationDetail, api_getPrivateLandAppliedDocumentList } = AdvertisementApiList()
    ...
    const getApplicationDetail = () => {
        ...
        axios.post(`${api_getPrivateLandAppliedApplicationDetail}`, requestBody, ApiHeader())
    ...
    const getAppliedDocumentList = () => {
        ...
        axios.post(`${api_getPrivateLandAppliedDocumentList}`, requestBody, ApiHeader())
            .then(function (response) {
...
export default PrivateLandApplicationFullDetail