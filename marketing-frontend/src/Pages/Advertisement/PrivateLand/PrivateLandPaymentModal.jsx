...
function PrivateLandPaymentModal(props) {
    // Modal.setAppElement('#yourAppElement');
    const [modalIsOpen, setIsOpen] = React.useState(false);

    const { api_getPrivateLandOrderIdForPayment } = AdvertisementApiList()
    ...
    const payNow = (e) => {
        ...
        axios.post(`${api_getPrivateLandOrderIdForPayment}`, requestBody, ApiHeader())
...
export default PrivateLandPaymentModal;
