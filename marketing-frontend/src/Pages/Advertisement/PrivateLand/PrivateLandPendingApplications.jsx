...
function PrivateLandPendingApplications(props) {
    ...
    const { api_getPrivateLandAppliedApplicationList, api_getPrivateLandApprovedApplicationList, api_getPrivateLandRejectedApplicationList } = AdvertisementApiList()
        ...
        <>
            ...
            <div className=''>
                <div className='flex bg-white p-2 mb-4 shadow-md  text-lg  font-semibold text-gray-500  '>
                    <h1 className='flex-1'>Private Land Application</h1>
